'''
use dog-cat dataset to verify AutoEncoder algorithm
...
plot_model(model, show_shapes=True, to_file='predict.png')
...
ax = sns.heatmap(cm, annot=True, annot_kws={"size": 16}, linewidths=.5, cbar=False,
        xticklabels=classes, yticklabels=classes, square=True, cmap='Blues_r', fmt='.2f')
